...
from mpnn.args import SklearnPredictArgs, SklearnTrainArgs
from mpnn.data import get_data
from mpnn.features import get_features_generator
from mpnn.sklearn_train import predict
from mpnn.utils import makedirs, timeit
...
def predict_sklearn(args: SklearnPredictArgs) -> None:
   ...
   :param args: A :class:`~mpnn.args.SklearnPredictArgs` object containing arguments for
