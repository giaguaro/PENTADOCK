...
import numpy as np
from mpnn.data.data import MoleculeDataLoader
from scipy.special import erfinv, softmax, logit, expit
from scipy.optimize import fmin
from scipy.stats import t
from sklearn.isotonic import IsotonicRegression

from mpnn.data import MoleculeDataset, StandardScaler
from mpnn.models import MoleculeModel
from mpnn.uncertainty.uncertainty_predictor import build_uncertainty_predictor, UncertaintyPredictor
...
class PlattCalibrator(UncertaintyCalibrator):
    ...
    def calibrate(self):
        ...
        if self.calibration_predictor.train_class_sizes is not None:
            ...
            print(
                "Class sizes used in training models unavailable in checkpoints before mpnn v1.5.0. "
