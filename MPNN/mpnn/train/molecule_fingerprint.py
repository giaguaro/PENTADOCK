...
from mpnn.args import FingerprintArgs, TrainArgs
from mpnn.data import get_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset
from mpnn.utils import load_args, load_checkpoint, makedirs, timeit, load_scalers, update_prediction_args
from mpnn.data import MoleculeDataLoader, MoleculeDataset
from mpnn.features import set_reaction, set_explicit_h, set_adding_hs, set_keeping_atom_map, reset_featurization_parameters, set_extra_atom_fdim, set_extra_bond_fdim
...
def mpnn_fingerprint() -> None:
    """
    Parses mpnn predicting arguments and returns the latent representation vectors for
