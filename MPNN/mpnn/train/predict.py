...
from mpnn.data import MoleculeDataLoader, MoleculeDataset, StandardScaler, AtomBondScaler
from mpnn.models import MoleculeModel
from mpnn.nn_utils import activate_dropout
...
def predict(
    ...
    :param scaler: A :class:`~mpnn.features.scaler.StandardScaler` object fit on the training targets.
