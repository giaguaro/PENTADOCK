...
from mpnn.data import MoleculeDataLoader, MoleculeDataset, AtomBondScaler
from mpnn.models import MoleculeModel
from mpnn.nn_utils import compute_gnorm, compute_pnorm, NoamLR
...
def train(
    ...
    :param data_loader: A :class:`~mpnn.data.data.MoleculeDataLoader`.
    :param loss_func: Loss function.
    :param optimizer: An optimizer.
    :param scheduler: A learning rate scheduler.
    :param args: A :class:`~mpnn.args.TrainArgs` object containing arguments for training the model.
    ...
    for batch in tqdm(data_loader, total=len(data_loader), leave=False):
        ...
        model.zero_grad()
        preds = model(
            mol_batch.cuda(non_blocking=True),
            features_batch.cuda(non_blocking=True),
            atom_descriptors_batch.cuda(non_blocking=True),
            atom_features_batch.cuda(non_blocking=True),
            bond_descriptors_batch.cuda(non_blocking=True),
            bond_features_batch.cuda(non_blocking=True),
            constraints_batch.cuda(non_blocking=True),
            bond_types_batch.cuda(non_blocking=True),
        )
